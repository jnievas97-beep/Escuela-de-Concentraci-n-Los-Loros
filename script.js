...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (
        ...
        ayudaIOS.className =
            "ayuda-instalacion-ios";


        ayudaIOS.innerHTML =
            '<button type="button" class="cerrar-ayuda-ios" aria-label="Cerrar instrucciones">×</button>' +
            '<strong>📲 Instalar en iPhone o iPad</strong>' +
            '<span>En Safari, toca <b>Compartir</b> y luego <b>Agregar a pantalla de inicio</b>.</span>';
        ...
        if (cerrarAyudaIOS) {
            ...
            cerrarAyudaIOS.addEventListener(
                "click",
                function () {
