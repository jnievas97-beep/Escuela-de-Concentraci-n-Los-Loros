...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function actualizarGuiaInstalacion() {
        ...
        if (esSamsungInternet) {
            ...
            instruccionRecomendada.innerHTML =
                "<h3>Instalar en Samsung</h3>" +
                "<ol>" +
                    "<li>Toca el menú <strong>☰</strong> de Samsung Internet.</li>" +
                    "<li>Busca <strong>Agregar página a</strong> o una opción similar.</li>" +
                    "<li>Selecciona <strong>Pantalla de inicio</strong>.</li>" +
                    "<li>Confirma para crear el acceso de Escuela Los Loros.</li>" +
                "</ol>";
        ...
        if (esChromeAndroid) {
            ...
            instruccionRecomendada.innerHTML =
                ...
                "</ol>" +
                "<p>Si la opción no aparece todavía, espera a que la página termine de cargar y vuelve a abrir este menú.</p>";
