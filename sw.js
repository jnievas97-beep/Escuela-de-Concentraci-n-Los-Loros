/* Firebase Cloud Messaging · Fase 1 COMPLETA · 20260907-4 */
...
const CACHE_VERSION = "escuela-los-loros-20260907-4";

const ARCHIVOS_BASE = [
    "./",
    "./index.html",
    "./style.css?v=20260907-4",
    "./script.js?v=20260907-4",
    "./notificaciones-config.js?v=20260907-4",
    "./manifest.webmanifest?v=20260907-4",
    "./imagenes/logo.png",
